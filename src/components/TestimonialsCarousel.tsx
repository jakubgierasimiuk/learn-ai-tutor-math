    ...
    <section className="py-24 px-6 bg-gradient-to-br from-primary/5 via-background to-accent/5">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl max-w-3xl mx-auto text-muted-foreground leading-relaxed animate-fadeIn" style={{animationDelay: '0.4s'}}>
            Zobacz, jak mentavo.ai zmienia sposób nauki matematyki w całej Polsce
          </p>
        </div>
