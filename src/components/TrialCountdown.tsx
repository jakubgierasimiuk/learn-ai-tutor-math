    ...
    return (
      <div className="flex items-center justify-between p-3 bg-gradient-subtle rounded-lg border border-border/50">
        <div className="flex items-center space-x-3">
          ...
          <span className="text-sm text-muted-foreground">do końca trialu</span>
        </div>
        <Button 
          size="sm" 
          onClick={onUpgrade}
        ...
        >
          Ulepsz <ArrowRight className="w-3 h-3 ml-1" />
        </Button>
      </div>
    );
  }
    ...
    <Card className="border-primary/20 bg-gradient-subtle">
      ...
      <CardContent className="space-y-4">
        ...
        <p className="text-xs text-center text-muted-foreground">
          Ulepsz teraz i zachowaj wszystkie funkcje Premium
        </p>
      </CardContent>
    </Card>
  );
