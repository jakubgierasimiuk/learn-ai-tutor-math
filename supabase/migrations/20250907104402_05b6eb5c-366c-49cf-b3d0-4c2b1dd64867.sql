...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_study_sessions_user_skill 
ON study_sessions(user_id, skill_id);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_learning_interactions_session_timestamp 
